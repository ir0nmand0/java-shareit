...
public interface ItemRepository extends JpaRepository<Item, Long> {
    ...
    Collection<Item> findByUserId(final long userId);
    ...
    Optional<Item> findByRequestId(final long id);

    Optional<Item> findByUserIdAndRequestId(final long userId, final long requestId);
}
